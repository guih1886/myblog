    ...
    <div className='content'>
      <div className='contact'>
        ...
        <div className="l1">
          ...
          <a href='https://www.linkedin.com/in/guih1886/' target='_blank' rel='noreferrer'>
            <ImLinkedin size={80} color={'#0077b5'} />
          </a>
          <a href='https://github.com/guih1886' target='_blank' rel='noreferrer'>
            <ImGithub size={80} color={'#fff'} />
          </a>
          <a href='mailto:guilherme_18henrique@yahoo.com.br' target='_blank' rel='noreferrer'>
