    ...
    <div className="content">
      <div className='project'>
        <div className="projects-list">
          ...
          <ProjectItem media={galeria} title="Galeria de Fotos" description={'Projeto de galeria de fotos, aonde é possível fazer um filtro por cidades desenvoldido com HTML, JavaScript e SCSS.'} route={'/galeria'} linkGit={'https://github.com/guih1886/Projetos/tree/main/Front-End/Projeto_Galeria'} />
          ...
          <ProjectItem media={cotacao} title='Sistema de Cotação - Andamento' description={'Projeto de um sistema de cotações, ainda em andamento. Com a necessidade de um sistema de cotação na empresa em que trabalho, vi a oportunidade de desenvolvê-lo. Por conter informações sensíveis, não estou disponibilizando o repositório.'} />
        </div>
      </div>
    </div>
  );
